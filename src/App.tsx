...
export default function App() {
  // English-only interface. The language switch has been intentionally removed.
  const lang = "en" as "bn" | "en";
  ...
  return (
    <div className={`min-h-screen ${theme === "dark" ? "dark bg-slate-950 text-slate-100" : "bg-slate-50 text-slate-800"} flex flex-col font-sans transition-all duration-300 relative overflow-x-hidden selection:bg-teal-500 selection:text-white`}>
      ...
      {/* Application Footer & Interactive Disclaimer */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-1.5 sm:gap-3 text-center sm:text-left">
            <p className="font-semibold text-slate-750 dark:text-slate-300">
              © 2026 Indian Property Developer & Cost Estimator.
            </p>
          </div>
              ...
              <div className="space-y-4.5 my-2">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                      {"This application provides preliminary planning and estimation support only. Its owners and operators accept no legal, civil, or financial liability for real-world construction execution, onsite engineering, or financial decisions made using the application's data."}
                    </p>
                  </div>
                </div>
              </div>
